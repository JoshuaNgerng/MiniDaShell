...
/*   Updated: 2023/01/05 13:00:23 by jngerng          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	proc_sign_int(int fd, t_sign_int_pro s_int, int input, int space)
{
	int		a;
	int		b;
	t_int	num;
...
int	write_sign_int(int fd, t_flags flag, int input)
{
	...
	p.i = num;
	p.f = flag;
	return (proc_sign_int(fd, p, input, space));
}
